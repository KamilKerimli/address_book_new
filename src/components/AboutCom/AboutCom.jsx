...
const AboutCom = () => {
  return (
    <div class="container mx-auto px-4 py-8">
        <div class="bg-white rounded-lg overflow-hidden shadow-xl shadow-blue-400 dark:bg-blue-600">
            <div class="flex flex-col lg:flex-row px-4 pt-16 lg:px-10 dark:bg-blue-600">
                <div class="w-full lg:w-1/2 mb-8 lg:mb-0">
                    <h1 class="text-black text-center lg:text-start text-3xl lg:text-5xl font-semibold mb-6 dark:text-white">Enhance your learning experience with interactive video features.</h1>
                    <p class="text-gray-700 dark:text-gray-400 text-center lg:text-start text-lg lg:text-xl font-bold mb-6">
            ...
            <p class="px-4 lg:px-10 text-base lg:text-lg font-bold mt-6 pb-6 dark:bg-blue-600 dark:text-white text-black">
